...
---
title: House Prices - Advanced Regression Techniques3
...
imp_lotfront=impute(trn_tst_numeric, cols = list(LotFrontage=imputeLearner(makeLearner("regr.lm"),features = "LotArea"),MasVnrArea=imputeMedian(),BsmtFinSF1=imputeMedian(),BsmtFinSF2=imputeMedian(),BsmtUnfSF=imputeMedian(),
